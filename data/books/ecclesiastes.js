...
export const ecclesiastes = {
  id: 'ecclesiastes',
  audioBasePath: 'audio/ecclesiastes/', // chapter-01-cn.mp3 … chapter-12-en.mp3
  ...
  chapters: [
    { num: 1, theme: 'meaning', titleZh: '一切都是虚空', titleEn: 'All is vapor',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-01-cn.mp3', en: 'audio/ecclesiastes/chapter-01-en.mp3' } },
    { num: 2, theme: 'meaning', titleZh: '成功的空洞', titleEn: 'The emptiness of success',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-02-cn.mp3', en: 'audio/ecclesiastes/chapter-02-en.mp3' } },
    { num: 3, theme: 'time', titleZh: '凡事都有定时', titleEn: 'A time for everything',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-03-cn.mp3', en: 'audio/ecclesiastes/chapter-03-en.mp3' } },
    { num: 4, theme: 'wisdom', titleZh: '竞争、孤独与压迫', titleEn: 'Rivalry, loneliness, oppression',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-04-cn.mp3', en: 'audio/ecclesiastes/chapter-04-en.mp3' } },
    { num: 5, theme: 'fear-god', titleZh: '钱不能满足人', titleEn: 'Money cannot satisfy',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-05-cn.mp3', en: 'audio/ecclesiastes/chapter-05-en.mp3' } },
    { num: 6, theme: 'meaning', titleZh: '拥有不等于享受', titleEn: 'Having is not enjoying',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-06-cn.mp3', en: 'audio/ecclesiastes/chapter-06-en.mp3' } },
    { num: 7, theme: 'wisdom', titleZh: '智慧面对死亡', titleEn: 'Wisdom faces death',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-07-cn.mp3', en: 'audio/ecclesiastes/chapter-07-en.mp3' } },
    { num: 8, theme: 'time', titleZh: '公义延迟，人心困惑', titleEn: 'Delayed justice, human confusion',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-08-cn.mp3', en: 'audio/ecclesiastes/chapter-08-en.mp3' } },
    { num: 9, theme: 'death', titleZh: '死亡临到众人', titleEn: 'Death comes to all',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-09-cn.mp3', en: 'audio/ecclesiastes/chapter-09-en.mp3' } },
    { num: 10, theme: 'wisdom', titleZh: '愚昧如何破坏人生', titleEn: 'How folly damages life',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-10-cn.mp3', en: 'audio/ecclesiastes/chapter-10-en.mp3' } },
    { num: 11, theme: 'death', titleZh: '在不确定中仍然行动', titleEn: 'Acting amid uncertainty',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-11-cn.mp3', en: 'audio/ecclesiastes/chapter-11-en.mp3' } },
    { num: 12, theme: 'fear-god', titleZh: '趁年幼记念造你的主', titleEn: 'Remember your Creator',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-12-cn.mp3', en: 'audio/ecclesiastes/chapter-12-en.mp3' } }
  ],
