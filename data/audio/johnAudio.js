 ...
 *
 *   audio/john/chapter-01-zh-female.mp3 … chapter-21-zh-female.mp3   (Chinese)
 *   audio/john/chapter-01-en-female.mp3 … chapter-21-en-female.mp3   (English)
 */
export const johnAudio = {
  ...
  chapters: [
    ...
    ...c,
    audio: {
      zh: `audio/john/chapter-${String(c.num).padStart(2, '0')}-zh-female.mp3`,
      en: `audio/john/chapter-${String(c.num).padStart(2, '0')}-en-female.mp3`
    }
  }))
};
