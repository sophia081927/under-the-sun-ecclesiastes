...
export const bibleRegistry = [
  ...
  },
  {
    ...
    study: null,
    deck: null,
    bookType: 'Apocalypse & Hope',
    bookTypeZh: '启示与盼望',
    themeZh: '耶稣是主、警醒、忠心、忍耐、盼望、得胜、万物更新',
    themeEn: 'Jesus is Lord, watchfulness, faithfulness, perseverance, hope, victory, all things made new',
    taglineZh: '在动荡中看见耶稣的得胜、安慰与盼望。',
    taglineEn: 'Seeing the victory, comfort, and hope of Jesus in troubled times.',
    descriptionZh: '圣经故事的终章。启示录的中心不是恐惧,而是耶稣:无论世界多混乱,神仍掌权,基督最终得胜,神要擦去眼泪、使万物更新。',
    descriptionEn: 'The final act of the Bible’s story. Revelation’s center is not fear but Jesus: however chaotic the world, God reigns, Christ finally wins, and God will wipe away tears and make all things new.',
    keyVerse: {
      zh: { reference: '启示录 21:5', text: '看哪，我将一切都更新了！' },
      en: { reference: 'Revelation 21:5', text: 'Behold, I am making all things new!' }
    },
    bgColor: 'from-[#241436] to-[#12161A]',
    accentColor: '#E6C260',
