...
- 书卷方向：完整 22 章架构，不做末日时事对号入座；第 1、21、22 章为首批完整内容，其余章节以诚实概览逐步完善。
- 中文经文：新标点和合本（简体，公共领域），来源为 eBible.org 的 `cmn-cu89s` USFM。
- 英文经文：World English Bible（WEB，公共领域），来源为 eBible.org 的 `engwebp` USFM。
- 解读原则：以耶稣基督、教会的忠心忍耐和神使万物更新为中心；不同基督教传统存在差异时保持谦逊，不把象征武断对应现代国家、人物、战争、宗派或科技。
- 音频现状：真人录音尚未提供；页面使用清楚标注的设备合成朗读，并为未来真人 MP3 保留自动优先机制。
- 版权遗留：现有诗篇页面使用 NIV 精选经文，后续应迁移为 WEB 或补足符合授权要求的版权声明；不得以 NIV 扩展完整书卷。
