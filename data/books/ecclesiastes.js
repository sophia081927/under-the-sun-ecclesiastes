...
export const ecclesiastes = {
  id: 'ecclesiastes',
  audioBasePath: 'audio/ecclesiastes/', // chapter-01-zh-female.mp3 … chapter-12-en-female.mp3
  ...
  chapters: [
    { num: 1, theme: 'meaning', titleZh: '一切都是虚空', titleEn: 'All is vapor',
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-01-zh-female.mp3', en: 'audio/ecclesiastes/chapter-01-en-female.mp3' } },
    { num: 2, theme: 'meaning', titleZh: '成功的空洞', titleEn: 'The emptiness of success',
      keyVerse: { reference: '传道书 2:11 · Ecclesiastes 2:11',
        ...
        en: 'Then I looked on all the works that my hands had wrought… and, behold, all was vanity… and there was no profit under the sun.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-02-zh-female.mp3', en: 'audio/ecclesiastes/chapter-02-en-female.mp3' } },
    { num: 3, theme: 'time', titleZh: '凡事都有定时', titleEn: 'A time for everything',
      keyVerse: { reference: '传道书 3:1,11 · Ecclesiastes 3:1,11',
        ...
        en: 'To every thing there is a season… He hath made every thing beautiful in his time: also he hath set the world in their heart.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-03-zh-female.mp3', en: 'audio/ecclesiastes/chapter-03-en-female.mp3' } },
    { num: 4, theme: 'wisdom', titleZh: '竞争、孤独与压迫', titleEn: 'Rivalry, loneliness, oppression',
      keyVerse: { reference: '传道书 4:9 · Ecclesiastes 4:9', zh: '两个人总比一个人好，因为二人劳碌同得美好的果效。', en: 'Two are better than one; because they have a good reward for their labour.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-04-zh-female.mp3', en: 'audio/ecclesiastes/chapter-04-en-female.mp3' } },
    { num: 5, theme: 'fear-god', titleZh: '钱不能满足人', titleEn: 'Money cannot satisfy',
      keyVerse: { reference: '传道书 5:10 · Ecclesiastes 5:10', zh: '贪爱银子的，不因得银子知足；贪爱丰富的，也不因得利益知足。', en: 'He that loveth silver shall not be satisfied with silver; nor he that loveth abundance with increase.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-05-zh-female.mp3', en: 'audio/ecclesiastes/chapter-05-en-female.mp3' } },
    { num: 6, theme: 'meaning', titleZh: '拥有不等于享受', titleEn: 'Having is not enjoying',
      keyVerse: { reference: '传道书 6:9 · Ecclesiastes 6:9', zh: '眼睛所看的，比心里妄想的倒好。这也是虚空，也是捕风。', en: 'Better is the sight of the eyes than the wandering of the desire: this is also vanity and vexation of spirit.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-06-zh-female.mp3', en: 'audio/ecclesiastes/chapter-06-en-female.mp3' } },
    { num: 7, theme: 'wisdom', titleZh: '智慧面对死亡', titleEn: 'Wisdom faces death',
      keyVerse: { reference: '传道书 7:2 · Ecclesiastes 7:2', zh: '往遭丧的家去，强如往宴乐的家去；因为死是众人的结局，活人也必将这事放在心上。', en: 'It is better to go to the house of mourning, than to go to the house of feasting: for that is the end of all men.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-07-zh-female.mp3', en: 'audio/ecclesiastes/chapter-07-en-female.mp3' } },
    { num: 8, theme: 'time', titleZh: '公义延迟，人心困惑', titleEn: 'Delayed justice, human confusion',
      keyVerse: { reference: '传道书 8:17 · Ecclesiastes 8:17', zh: '我就看明神一切的作为，知道人查不出日光之下所做的事。', en: 'Then I beheld all the work of God, that a man cannot find out the work that is done under the sun.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-08-zh-female.mp3', en: 'audio/ecclesiastes/chapter-08-en-female.mp3' } },
    { num: 9, theme: 'death', titleZh: '死亡临到众人', titleEn: 'Death comes to all',
      keyVerse: { reference: '传道书 9:7 · Ecclesiastes 9:7', zh: '你只管去欢欢喜喜吃你的饭，心中快乐喝你的酒，因为神已经悦纳你的作为。', en: 'Go thy way, eat thy bread with joy, and drink thy wine with a merry heart; for God now accepteth thy works.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-09-zh-female.mp3', en: 'audio/ecclesiastes/chapter-09-en-female.mp3' } },
    { num: 10, theme: 'wisdom', titleZh: '愚昧如何破坏人生', titleEn: 'How folly damages life',
      keyVerse: { reference: '传道书 10:12 · Ecclesiastes 10:12', zh: '智慧人的口说出恩言；愚昧人的嘴吞灭自己。', en: "The words of a wise man's mouth are gracious; but the lips of a fool will swallow up himself." },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-10-zh-female.mp3', en: 'audio/ecclesiastes/chapter-10-en-female.mp3' } },
    { num: 11, theme: 'death', titleZh: '在不确定中仍然行动', titleEn: 'Acting amid uncertainty',
      keyVerse: { reference: '传道书 11:1 · Ecclesiastes 11:1', zh: '当将你的粮食撒在水面，因为日久必能得着。', en: 'Cast thy bread upon the waters: for thou shalt find it after many days.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-11-zh-female.mp3', en: 'audio/ecclesiastes/chapter-11-en-female.mp3' } },
    { num: 12, theme: 'fear-god', titleZh: '趁年幼记念造你的主', titleEn: 'Remember your Creator',
      keyVerse: { reference: '传道书 12:1,13 · Ecclesiastes 12:1,13', zh: '你趁着年幼……当记念造你的主。……敬畏神，谨守他的诫命，这是人所当尽的本分。', en: 'Remember now thy Creator in the days of thy youth… Fear God, and keep his commandments: for this is the whole duty of man.' },
      ...
      audio: { zh: 'audio/ecclesiastes/chapter-12-zh-female.mp3', en: 'audio/ecclesiastes/chapter-12-en-female.mp3' } }
  ],
